...
require(MCMCpack)
require(STBEU)
dirsol = "~/Documents/Articles/STBEU/Coding/Data/all" # Directory where results will be 



###############################################
# setting 3  (balanced locations in space and time)
###############################################
...
while(i<=nsim)
{
  ...
  i=i+1
  setwd(dirsol)
  write.csv(results, "regular_results_spacetimeGN15.csv")
}
