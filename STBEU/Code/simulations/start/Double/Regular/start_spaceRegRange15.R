...
while(i<=nsim)
{
  ...
  ### eucliden likelihood ################ 
  res2=STBEUFit(theta,fix,coords,times,cc,data,type_dist,maxdist ,maxtime,winc_s=winc,winstp_s = winstp,0,0,type_subs,weighted)
  ...
  ### eucliden likelihood ################ 
  res3=STBEUFit(theta,fix,coords,times,cc,data,type_dist,maxdist ,maxtime,winc_s=winc,winstp_s = winstp,0,0,type_subs,weighted)
  ...
  ### eucliden likelihood ################ 
  res4=STBEUFit(theta,fix,coords,times,cc,data,type_dist,maxdist ,maxtime,winc_s=winc,winstp_s = winstp,0,0,type_subs,weighted)
  ...
  i=i+1
  setwd(dirsol)
  write.csv(results, "regular_results_spaceDE15.csv")
}
